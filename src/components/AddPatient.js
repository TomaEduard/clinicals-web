...
class AddPatient extends React.Component {
    ...
    handleSubmit (event) {
        ...
        axios.post("http://localhost:8443/clinical-services/api/patients", data)
        .then(res => {
            // pop-up
            toast("Patient added succesfully!", {autoClose:2200, position:toast.POSITION.BOTTOM_CENTER})
        })
    }
